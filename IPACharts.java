...
public class ConsonantCharts extends JFrame {
        ...
        String[][] consonantChart = {
                        ...
                        { "N", "Uvular", "Nasal", "Uvular",
                                        "Uvulars are consonants articulated with the back of the tongue against or near the uvula.",
[O                                        "A nasal, also called a nasal occlusive or nasal stop in contrast with an oral stop or nasalized consonant, is an occlusive consonant produced with a lowered velum" },
                        ...
                        { "β", "Bilibial", "fricative", "Bilibial",
                                        "The soft palate is lowered, allowing air to pass through the nasal cavity while the lips are closed.",
[I                                        "A fricative is a consonant sound created by forcing air through a narrow channel between two articulators, which partially blocks the airstream" },
